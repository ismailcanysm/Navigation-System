...
import com.navigation.project.backend.iterator.GraphIterator;
import com.navigation.project.backend.iterator.INodeIterator;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // PATTERN 9: ITERATOR - Node gezinme
        System.out.println("PATTERN 9: ITERATOR - Şehirleri geziyoruz...");
        ...
        System.out.println("✓ 9. Iterator - Güvenli gezinme");
        System.out.println("✓ 10. Facade - Basit API");
        System.out.println("\n10/10 Pattern başarıyla çalıştı!");
    }
